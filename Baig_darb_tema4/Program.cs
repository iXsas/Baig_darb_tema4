                ...
                while (true)
                {
                    ...
                    switch (opera)
                    {
                        ...
                        case "s":
                            ...
                            break;
                        case "-":
                            Console.WriteLine($"Pasirinkite koki dienyno saraso numeri norite pasalinti");
                            int salinamasNr = Convert.ToInt32(Console.ReadLine());
                            var StudListRetrieve = _DiaryRepo.Retrieve();
                            for (int i = 0; i < StudListRetrieve.Count; i++)
                            {
                                if (i == salinamasNr) { _DiaryRepo.RemoveItem(StudListRetrieve[i]); }
                            }
                            Console.WriteLine($"Pasalinta");
                            break;
                    }
